...
The elastic net model performed slightly better on the validation set (MSE = `r round(mse_en,4)`) compared to the random forest (MSE = `r round(mse_rf,4)`). Therefore, we use the elastic net model to predict my ratings for the books in my to-be-read list.
